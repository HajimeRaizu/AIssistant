...
const UserType = () => {
    ...
    return (
      <div className="user-type-page">
        ...
        ><img src={logo} alt="AIssistant.png" style={{height: '50px', width: '50px'}}/><h1 className='ai' style={{color: '#085f93'}}>AI</h1><h1 className='landing-welcome'>ssistant</h1></div>
        <div className='aissistant-2' style={{}}>
          <h1 className='ai' style={{color: '#085f93', fontSize: '70px'}}>AI</h1><h1 className='landing-welcome' style={{fontSize: '70px'}}>ssistant</h1>
        </div>
        <section className="user-type-action-boxes">
          ...
          >
            <h2 style={{color: '#085f93'}}>Instructor</h2>
          ...
          <div
            ...
            onClick={() => handleBoxClick('/googleLogin')} // Redirect to Exercises page
          >
            <h2 style={{color: '#085f93'}}>Student</h2>
