...
const UserPage = () => {
  ...
  useEffect(() => {
    const fetchChats = async () => {
      try {
        const response = await axios.get(`https://aissistant-three.vercel.app/api/getChats/${userId}`);
  ...
  useEffect(() => {
    const fetchExercises = async () => {
      try {
        const response = await axios.get("https://aissistant-three.vercel.app/api/getExercises");
  ...
  const fetchChatHistory = async (chatId) => {
    try {
      const response = await axios.get(`https://aissistant-three.vercel.app/api/getChatHistory/${chatId}/${userId}`);
  ...
  const handleSend = async () => {
    ...
    try {
      const response = await axios.post("https://aissistant-three.vercel.app/api/llama", { input });
      ...
      await axios.post("https://aissistant-three.vercel.app/api/storeChat", {
  ...
  const handleChatNameSubmit = async () => {
    ...
    try {
      const response = await axios.post("https://aissistant-three.vercel.app/api/createChat", { chatName: chatNameInput, userId });
  ...
  const deleteChat = async (chatId) => {
    try {
      await axios.delete(`https://aissistant-three.vercel.app/api/deleteChat/${chatId}/${userId}`);
