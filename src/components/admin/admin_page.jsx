...
const AdminPage = () => {
  ...
  useEffect(() => {
    ...
    const fetchTotalUsers = async () => {
      try {
        const response = await axios.get("https://aissistant-gold.vercel.app/api/getUsers");
    ...
    const fetchUniversityInfo = async () => {
      try {
        const response = await axios.get("https://aissistant-gold.vercel.app/api/getUniversityInfo");
    ...
    const fetchInstructors = async () => {
      try {
        const response = await axios.get("https://aissistant-gold.vercel.app/api/getInstructors");
  ...
  const handleSaveUser = async (user) => {
    try {
      if (activeTab === 'settings') {
        // Update user
        await axios.put(`https://aissistant-gold.vercel.app/api/updateUser/${user.id}`, user);
        setUsers(users.map(u => u.id === user.id ? user : u));
      } else if (activeTab === 'instructors') {
        // Update instructor
        await axios.put(`https://aissistant-gold.vercel.app/api/updateInstructor/${user.id}`, user); // Use user.id (Firestore document ID)
  ...
  const handleDeleteUser = async (userId) => {
    try {
      await axios.delete(`https://aissistant-gold.vercel.app/api/deleteUser/${userId}`);
  ...
  const handleFileUpload = async (event) => {
    ...
    if (file) {
      ...
      try {
        const response = await axios.post("https://aissistant-gold.vercel.app/api/uploadUsers", formData, {
          headers: {
            "Content-Type": "multipart/form-data",
          },
        });
        alert("Users uploaded successfully!");
        const usersResponse = await axios.get("https://aissistant-gold.vercel.app/api/getUsers");
  ...
  const handleAddSingleUser = async () => {
    try {
      const response = await axios.post("https://aissistant-gold.vercel.app/api/addSingleUser", {
        name: newUserName,
        email: newUserEmail,
      });
  ...
  const handleUpdateUniversityInfo = async () => {
    try {
      await axios.put("https://aissistant-gold.vercel.app/api/updateUniversityInfo", { info: universityInfo });
  ...
  const handleUploadInstructors = async (event) => {
    ...
    if (file) {
      ...
      try {
        await axios.post("https://aissistant-gold.vercel.app/api/uploadInstructors", formData, {
          headers: {
            "Content-Type": "multipart/form-data",
          },
        });
  ...
  const handleAddSingleInstructor = async () => {
    try {
      await axios.post("https://aissistant-gold.vercel.app/api/addSingleInstructor", {
  ...
  const handleDeleteInstructor = async (email) => {
    try {
      await axios.delete(`https://aissistant-gold.vercel.app/api/deleteInstructor/${encodeURIComponent(email)}`);
